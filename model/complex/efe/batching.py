...
class Batch_Loader(object):
	...
	def __call__(self):
		...
		if self.neg_ratio > 0:
			...
			self.new_triples_values[last_idx:(last_idx*(self.neg_ratio+1))] = np.tile(self.new_triples_values[:last_idx], self.neg_ratio);#print(last_idx);print(self.neg_ratio)
